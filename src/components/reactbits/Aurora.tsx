...
export default function Aurora({
  ...
  useEffect(() => {
    ...
    const update = (t) => {
      ...
      program.uniforms.uTime.value = time !== undefined ? time : t * 0.01 * spd * 0.1;
      // Use t-based time when no explicit time prop
      if (time === undefined || time === t * 0.01) {
        program.uniforms.uTime.value = t * 0.001 * spd;
      }
      program.uniforms.uAmplitude.value = amp;
      program.uniforms.uBlend.value = bln;
